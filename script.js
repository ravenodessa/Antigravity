...
// Safely remove DOMContentLoaded since type="module" implies defer
...
function setupEventListeners() {
    ...
    if (saveBtn) saveBtn.addEventListener('click', saveTasksToJSON);
...
function saveTasksToLocalStorage() {
    try {
        ...
        alert("Не удалось сохранить данные. Возможно, переполнен LocalStorage.");
    }
}
